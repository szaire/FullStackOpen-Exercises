...
const Statistcs = ({ good, neutral, bad, func1, func2, func3 }) => {
  ...
  return (
    <div>
      ...
      <StatisticLine title={'all'} stat={func1} />
      <StatisticLine title={'avarage'} stat={func2} />
      <StatisticLine title={'positive'} stat={func3} />
    </div>
  )
}
